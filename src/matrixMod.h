...
int font_14x15[64][15] = {

    // Huruf 'A' (ASCII 65)
    {0x0000, 0x0000, 0x0380, 0x07C0, 0x07C0, 0x0C60, 0x0C60, 0x1FF0,
     0x1FF0, 0x1830, 0x1830, 0x1830, 0x1830, 0x0000, 0x0000},

    // Huruf 'B' (ASCII 66)
    {0x0000, 0x0000, 0x1FE0, 0x1FF0, 0x0C30, 0x0C30, 0x0FF0, 0x0FF0,
     0x0C30, 0x0C30, 0x0C30, 0x1FF0, 0x1FE0, 0x0000, 0x0000},

    // Huruf 'C' (ASCII 67)
    {0x0000, 0x0000, 0x07F0, 0x0FF8, 0x1C18, 0x1800, 0x1800, 0x1800,
     0x1800, 0x1C18, 0x0FF8, 0x07F0, 0x0000, 0x0000, 0x0000},

    // Huruf 'D' (ASCII 68)
    {0x0000, 0x0000, 0x1FE0, 0x1FF0, 0x0C38, 0x0C18, 0x0C18, 0x0C18,
     0x0C18, 0x0C38, 0x1FF0, 0x1FE0, 0x0000, 0x0000, 0x0000},

    // Huruf 'E' (ASCII 69)
    {0x0000, 0x0000, 0x1FF8, 0x1FF8, 0x1800, 0x1800, 0x1FC0, 0x1FC0,
     0x1800, 0x1800, 0x1FF8, 0x1FF8, 0x0000, 0x0000, 0x0000},

    // Huruf 'F' (ASCII 70)
    {0x0000, 0x0000, 0x1FF8, 0x1FF8, 0x1800, 0x1800, 0x1FC0, 0x1FC0,
     0x1800, 0x1800, 0x1800, 0x1800, 0x0000, 0x0000, 0x0000},

    // Huruf 'G' (ASCII 71)
    {0x0000, 0x0000, 0x07F0, 0x0FF8, 0x1C18, 0x1800, 0x1800, 0x1878,
     0x1878, 0x1C18, 0x1C18, 0x0FF8, 0x07F0, 0x0000, 0x0000},

    // Huruf 'H' (ASCII 72)
    {0x0000, 0x0000, 0x1830, 0x1830, 0x1830, 0x1830, 0x1FF0, 0x1FF0,
     0x1830, 0x1830, 0x1830, 0x1830, 0x0000, 0x0000, 0x0000},

    // Huruf 'I' (ASCII 73)
    {0x0000, 0x0000, 0x07E0, 0x07E0, 0x0180, 0x0180, 0x0180, 0x0180,
     0x0180, 0x0180, 0x07E0, 0x07E0, 0x0000, 0x0000, 0x0000},

    // Huruf 'J' (ASCII 74)
    {0x0000, 0x0000, 0x01F0, 0x01F0, 0x0060, 0x0060, 0x0060, 0x0060,
     0x1860, 0x1860, 0x1C60, 0x0FC0, 0x0780, 0x0000, 0x0000},

    // Huruf 'K' (ASCII 75)
    {0x0000, 0x0000, 0x1830, 0x1860, 0x18C0, 0x1980, 0x1F00, 0x1F00,
     0x1980, 0x18C0, 0x1860, 0x1830, 0x0000, 0x0000, 0x0000},
    ...
    // Huruf 'M' (ASCII 77)
    {0x0000, 0x0000, 0x606, 0x70E, 0x79E, 0x6D6, 0x666, 0x606,
     0x606, 0x606, 0x606, 0x606, 0x0000, 0x0000, 0x0000},

    // Huruf 'N' (ASCII 78)
    {0x0000, 0x0000, 0x606, 0x706, 0x786, 0x7C6, 0x6E6, 0x676,
     0x63E, 0x61E, 0x60E, 0x606, 0x606, 0x0000, 0x0000},

    // Huruf 'O' (ASCII 79)
    {0x0000, 0x0000, 0x1F8, 0x3FC, 0x606, 0x606, 0x606, 0x606,
     0x606, 0x606, 0x3FC, 0x1F8, 0x0000, 0x0000, 0x0000},

    // Huruf 'P' (ASCII 80)
    {0x0000, 0x0000, 0x7F8, 0x7FC, 0x606, 0x606, 0x7FC, 0x7F8,
     0x600, 0x600, 0x600, 0x600, 0x0000, 0x0000, 0x0000},

    // Huruf 'Q' (ASCII 81)
    {0x0000, 0x0000, 0x1F8, 0x30C, 0x606, 0x606, 0x606, 0x606,
     0x606, 0x30C, 0x1F8, 0x018, 0x00C, 0x0000, 0x0000},

    // Huruf 'R' (ASCII 82)
    {0x0000, 0x0000, 0x7F8, 0x7FC, 0x606, 0x606, 0x7FC, 0x7F8,
     0x60C, 0x606, 0x606, 0x606, 0x0000, 0x0000, 0x0000},

    // Huruf 'S' (ASCII 83)
    {0x0000, 0x0000, 0x1FC, 0x3FE, 0x606, 0x600, 0x3F8, 0x1FC,
     0x00E, 0x006, 0x606, 0x7FE, 0x3FC, 0x0000, 0x0000},

    // Huruf 'T' (ASCII 84)
    {0x0000, 0x0000, 0x7FE, 0x7FE, 0x060, 0x060, 0x060, 0x060,
     0x060, 0x060, 0x060, 0x060, 0x0000, 0x0000, 0x0000},

    // Huruf 'U' (ASCII 85)
    {0x0000, 0x0000, 0x606, 0x606, 0x606, 0x606, 0x606, 0x606,
     0x606, 0x606, 0x7FE, 0x3FC, 0x0000, 0x0000, 0x0000},

    // Huruf 'V' (ASCII 86)
    {0x0000, 0x0000, 0x606, 0x606, 0x606, 0x606, 0x606, 0x606,
     0x606, 0x606, 0x30C, 0x1F8, 0x0F0, 0x0000, 0x0000},

    // Huruf 'W' (ASCII 87)
    {0x0000, 0x0000, 0x606, 0x606, 0x606, 0x606, 0x606, 0x666,
     0x666, 0x666, 0x7E6, 0x3FC, 0x198, 0x0000, 0x0000},

    // Huruf 'X' (ASCII 88)
    {0x0000, 0x0000, 0x606, 0x606, 0x30C, 0x30C, 0x1F8, 0x0F0,
     0x0F0, 0x1F8, 0x30C, 0x30C, 0x606, 0x606, 0x0000},

    // Huruf 'Y' (ASCII 89)
    {0x0000, 0x0000, 0x606, 0x606, 0x30C, 0x30C, 0x1F8, 0x0F0,
     0x060, 0x060, 0x060, 0x060, 0x060, 0x0000, 0x0000},

    // Huruf 'Z' (ASCII 90)
    {0x0000, 0x0000, 0x7FE, 0x7FE, 0x00C, 0x018, 0x030, 0x060,
     0x0C0, 0x180, 0x300, 0x7FE, 0x7FE, 0x0000, 0x0000},

    // Angka '0'
    {0x0000, 0x0000, 0x1F8, 0x30C, 0x606, 0x606, 0x606, 0x606,
     0x606, 0x30C, 0x1F8, 0x0000, 0x0000, 0x0000, 0x0000},

    // Angka '1'
    {0x0000, 0x0000, 0x0030, 0x0070, 0x00F0, 0x01B0, 0x0030, 0x0030,
     0x0030, 0x0030, 0x03FE, 0x03FE, 0x0000, 0x0000, 0x0000},

    // Angka '2'
    {0x0000, 0x0000, 0x1F8, 0x30C, 0x006, 0x006, 0x00C, 0x018,
     0x030, 0x060, 0x3FE, 0x0000, 0x0000, 0x0000, 0x0000},

    // Angka '3'
    {0x0000, 0x0000, 0x1F8, 0x30C, 0x006, 0x006, 0x03C, 0x03C,
     0x006, 0x006, 0x30C, 0x1F8, 0x0000, 0x0000, 0x0000},

    // Angka '4'
    {0x0000, 0x0000, 0x018, 0x038, 0x078, 0x0D8, 0x198, 0x318,
     0x3FE, 0x018, 0x018, 0x0000, 0x0000, 0x0000, 0x0000},

    // Angka '5'
    {0x0000, 0x0000, 0x3FE, 0x300, 0x300, 0x3F8, 0x00C, 0x006,
     0x006, 0x30C, 0x1F8, 0x0000, 0x0000, 0x0000, 0x0000},

    // Angka '6'
    {0x0000, 0x0000, 0x0F8, 0x18C, 0x300, 0x300, 0x3F8, 0x30C,
     0x306, 0x306, 0x30C, 0x1F8, 0x0000, 0x0000, 0x0000},

    // Angka '7'
    {0x0000, 0x0000, 0x3FE, 0x006, 0x00C, 0x018, 0x030, 0x030,
     0x060, 0x060, 0x0C0, 0x0C0, 0x0000, 0x0000, 0x0000},

    // Angka '8'
    {0x0000, 0x0000, 0x1F8, 0x30C, 0x606, 0x606, 0x30C, 0x1F8,
     0x30C, 0x606, 0x606, 0x30C, 0x1F8, 0x0000, 0x0000},

    // Angka '9'
    {0x0000, 0x0000, 0x1F8, 0x30C, 0x30C, 0x30C, 0x30C, 0x1FC,
     0x00C, 0x00C, 0x30C, 0x1F8, 0x0000, 0x0000, 0x0000},
};
...
void drawText10x14(int startX, int startY, const char *text)
{
  ...
  while (*text)
  {
    ...
    {
      fontData = font_14x15[*text - 'A'];
      geser = 0;
    }

    else if (*text >= '0' && *text <= '9')
    {
      fontData = font_14x15[*text - '0' + 26];
      geser = 2;
    }
